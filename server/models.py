...
class Restaurant(db.Model, SerializerMixin):
    ...
    # ✅ Relationship to RestaurantPizza (FIXED)
    restaurant_pizzas = db.relationship("RestaurantPizza", backref="restaurant", cascade="all, delete-orphan")

    serialize_rules = ("-restaurant_pizzas.restaurant",)  # Prevent circular serialization
...
class Pizza(db.Model, SerializerMixin):
    ...
    serialize_rules = ("-restaurant_pizzas.pizza",)  # Prevent circular serialization
